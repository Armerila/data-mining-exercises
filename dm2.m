...
diff12 = sum(imabsdiff(num1,num2));
diff13 = sum(imabsdiff(num1,num3));
diff23 = sum(imabsdiff(num2,num3));

test = imabsdiff(num1,num2)
test1 = imabsdiff(num1,num3)
test2 = imabsdiff(num2,num3)
imshow(test)
imshow(test1)
imshow(test2)
